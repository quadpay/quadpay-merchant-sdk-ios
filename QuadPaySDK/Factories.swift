...
func updateHtmlContent(learnMoreUrl: String, merchantId: String, isMFPPMerchant: String, minModal: String, hasFees: String) -> String {
    let urlPath = Bundle.qpResource.path(forResource: "index", ofType: "html", inDirectory: "www")
    do{
        ...
        strHTMLContent = strHTMLContent.replacingOccurrences(of: "%hasFees%", with: hasFees)
